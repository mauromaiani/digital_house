...
$sql = "select movies.id, movies.title, movies.rating, genres.name from movies, genres where genres.id = movies.genre_id order by movies.title";
  ...
  <body>
    ...
    <select name="pelicula" id="pelicula">
        ...
        <?php foreach ($peliculas as $key => $value) :?>
            <option href="pelicula.php?id=<?=$value["id"];?>" value="<?=$value["id"] ;?>">
              <?=$value["title"];?>
            </option>
        <?php endforeach;?>
    ...
    <ul>
        <?php foreach ($peliculas as $key => $value) : ?>
            <li>
              <a href="pelicula.php?id=<?=$value["id"];?>">
                <?=$value["title"];?>
              </a>
            </li>
        <?php  endforeach;?>
